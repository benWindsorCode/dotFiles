...
(setq org-directory "~/Documents/code/orgFiles/")
...
(with-eval-after-load 'org
  ...
  (setq org-capture-templates '(("t" "Todo [inbox]" entry
                               (file+headline "~/Documents/code/orgFiles/gtd/inbox.org" "Tasks")
                               "* TODO %i%?")
                              ("T" "Tickler" entry
                               (file+headline "~/Documents/code/orgFiles/gtd/tickler.org" "Tickler")
                               "* %i%? \n %U")))

  (setq org-refile-targets '(("~/Documents/code/orgFiles/gtd/gtd.org" :maxlevel . 3)
                           ("~/Documents/code/orgFiles/gtd/someday.org" :level . 1)
